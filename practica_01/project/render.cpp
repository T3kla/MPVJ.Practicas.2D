...
GLFWwindow *Render::GetWindow() { return Get().window; }

void Render::SetWindow(GLFWwindow *window) { Get().window = window; }
...
const Color &Render::GetBgColor() { return instance.bgColor; }

void Render::SetBgColor(const Color &color) { instance.bgColor = color; }
