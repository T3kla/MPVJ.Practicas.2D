...
{
    return Vec2::Angle(*this, f2Right);
}
...
float Vec2::DistanceSq(const Vec2 &a, const Vec2 &b)
{
...
const Vec2i &Vec2i::Up()
{
    return i2Up;
}
const Vec2i &Vec2i::Down()
{
    return i2Down;
}
const Vec2i &Vec2i::Right()
{
    return i2Right;
}
const Vec2i &Vec2i::Left()
{
    return i2Left;
}
